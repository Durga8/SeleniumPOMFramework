...
namespace SeleniumFrameWork.Helpers
{
    public class ExcelDataByRC
    {
        ...
        public static string getDataByRC(string WorkbookName, string SheetName, string ColName, int rowNum)
        {
            string newSheetName = "";
            ...
            string variable = getCellData(WorkbookName, newSheetName, ColName, rowNum);

            return variable;
        }

        public static void setDataByRC(string WorkbookName, string SheetName, string colName, int rowNumber, string dataValue)
        {
            string newSheetName = "";
            string env = ExcelHelpers.getParameter("Environment");
            if (env.Equals("UAT"))
            ...
            setCellData(WorkbookName, newSheetName, colName, rowNumber, dataValue);
